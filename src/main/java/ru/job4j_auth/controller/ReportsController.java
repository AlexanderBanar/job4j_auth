...
import ru.job4j_auth.domain.Report;
...
public class ReportsController {
    ...
    @PostMapping("/")
    public ResponseEntity<Person> create(@RequestParam String login, @RequestParam String password) {
    ...
    @PutMapping("/")
    public ResponseEntity<Void> update(@RequestParam int id, @RequestParam String login,
